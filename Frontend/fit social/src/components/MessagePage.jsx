...
const MessagePage = () => {
  ...
  return (
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className='bg-no-repeat bg-cover h-screen'>
      ...
      <section className='flex flex-col h-[calc(100vh-128px)] overflow-auto scrollbar bg-slate-200 bg-opacity-50'>
        ...
        {message.imageUrl && (
          <div className='w-full sticky bottom-0 bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden'>
