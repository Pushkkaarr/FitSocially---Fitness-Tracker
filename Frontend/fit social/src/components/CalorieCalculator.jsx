    ...
    <div className="font-cambria max-w-3xl mx-auto p-6 bg-gradient-to-r from-sky-400 to-blue-600 shadow-lg rounded-lg border border-blue-800">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <form
          ...
          className={`block text-gray-700 font-bold mb-2 space-y-6 bg-white bg-opacity-70 rounded-lg p-6 shadow-lg flex-1 transition-all duration-300 ${result ? "mb-0" : "mb-4"}`}
        >
          <div className="flex flex-wrap -mx-2">
            <div className="w-full md:w-1/2 px-2 mb-4">
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.age ? "border-red-500" : "focus:ring-indigo-500"} bg-white text-gray-800`}
            ...
            <div className="w-full md:w-1/2 px-2 mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.gender ? "border-red-500" : "focus:ring-indigo-500"} bg-white text-gray-800`}
              >
          ...
          <div className="flex flex-wrap -mx-2">
            <div className="w-full md:w-1/2 px-2 mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.height ? "border-red-500" : "focus:ring-indigo-500"} bg-white text-gray-800`}
            ...
            <div className="w-full md:w-1/2 px-2 mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.weight ? "border-red-500" : "focus:ring-indigo-500"} bg-white text-gray-800`}
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.activityLevel ? "border-red-500" : "focus:ring-indigo-500"} bg-white text-gray-800`}
            >
          ...
          <div className="mb-6">
            ...
            <select
              ...
              value={formData.goal}
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 ${errors.goal ? "border-red-500" : "focus:ring-indigo-500"} bg-white text-gray-800`}
            >
