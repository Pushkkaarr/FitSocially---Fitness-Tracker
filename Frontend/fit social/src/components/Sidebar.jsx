          ...
          <div className='flex-1'>
            ...
            <div className='h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar'>
              ...
              {allUser.map((conv, index) => (
                <NavLink to={"/chat/" + conv?.userDetails?._id} key={conv?._id} className='flex items-center gap-2 py-3 px-2 border border-transparent hover:border-primary rounded hover:bg-slate-100 cursor-pointer'>
                  <div>
