...
import placeholderImage from '../assets/peakpx.jpg'; // Adjust the path as necessary
...
const LandingPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800">
      <header className="px-4 lg:px-6 h-14 flex items-center bg-white dark:bg-blue-950 shadow-md">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <Link className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 hover:underline underline-offset-4" to="#features">
            Features
          </Link>
          <Link className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 hover:underline underline-offset-4" to="#about">
            About
          </Link>
    ...
    style={{
    backgroundImage: `url(https://w0.peakpx.com/wallpaper/663/974/HD-wallpaper-sports-fitness-girl-woman-thumbnail.jpg)`,
    width: '100%',       // Full width
    height: '500px',     // Adjust height for a better aspect ratio
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-blue-100 md:text-xl drop-shadow">
                  FitSocially combines fitness and social networking to help you achieve your health goals while
                  connecting with like-minded individuals.
                </p>
              </div>
              <div className="space-x-4">
                <Link to="/email">
                  <button className="bg-white text-blue-600 hover:bg-blue-50 px-4 py-2 rounded">Try Out</button>
                </Link>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {[
                ...
                <div key={index} className="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 p-6 rounded-lg">
                  <div className="flex items-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8 text-blue-600 dark:text-blue-400 mr-2">
                      <path d={getIconPath(feature.icon)}></path>
                    </svg>
                    <h3 className="text-xl font-bold text-blue-700 dark:text-blue-300">{feature.title}</h3>
                  </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-blue-600 to-blue-800">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">Stay Fit, Stay Connected</h2>
                <p className="max-w-[900px] text-blue-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  FitSocially brings together the best of both worlds - fitness and social networking. Achieve your
                  health goals while building meaningful connections with others on the same journey.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="grid gap-6 lg:grid-cols-2 items-center">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <p className="max-w-[600px] text-blue-700 dark:text-blue-200 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Maintain your streak for 1-2 months and unlock exclusive discounts on premium gym products like
                  creatine supplements and more!
                </p>
                <div className="bg-white dark:bg-blue-950 border border-blue-200 dark:border-blue-700 p-6 rounded-lg">
                  <div className="flex items-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8 text-blue-600 dark:text-blue-400 mr-2">
